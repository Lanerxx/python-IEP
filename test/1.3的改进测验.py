...
# =============================3.利用带权重k临近迭代比较距离后预测，对比f1，获得最终权重，排序=============================
print("=============================3.利用带权重k临近迭代比较距离后预测，对比f1，获得最终权重，排序=============================")
...
def weightDistant_score111(index):
    prediect = []
    # 测试每一项数据
    for row in range(0, sumDates):
        distant1 = 0
...
while indexFeature < sumFeatures:
    ...
    f1_features.append(weightDistant_score111(indexFeature))
    indexFeature += 1
for f1 in f1_features:
    if macF1<f1: macF1 = f1
    print(f1)
...
for count in range(0,3):
    ...
    while indexFeature < sumFeatures:
        ...
        print(features[indexFeature])
        w = 0
        while w < featureWeight[indexFeature] + 1:
